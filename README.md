...
<body>
    ...
    <header>
        <h1>HARIESH'S RESTAURANT- Menu</h1>
    </header>
...
<body>
    ...
    <header>
        <h1>HARIESH'S RESTAURANT- Contact Us</h1>
    </header>
    ...
    <section>
        ...
        <div class="contact-info">
            ...
            <p><strong>Email:</strong> <a href="mailto:contact@restaurant.com">contact@hariesh'srestaurant.com</a></p>
        </div>
